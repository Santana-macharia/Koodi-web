    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
         <li>
            ...
            <li>
                <a href="#"><i class="fa fa-money"></i> @lang('app.payments')<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li> <a href="{{ route('payments_success') }}">@lang('app.status_success')</a></li>
                    <li> <a href="{{ route('payments') }}">@lang('app.status_pending')</a> </li>
                    <li> <a href="{{ route('payments_initial') }}">@lang('app.status_initial')</a> </li>
                 </ul>
                <!-- /.nav-second-level -->
            </li>
           ...
           <!--  <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>  <a href="{{ route('sell') }}">@lang('app.post_an_ad')</a> </li>
