                     ...
                     <div class="modern-top-hom-cat-section">
                        ...
                        <div class="modern-home-search-bar-wrap">
                            <div class="search-wrapper">
                                <h3>  SELL YOUR MUSIC WORLDWIDE</h3>
                                 <h3>  Get your music on Spotify, iTunes/Apple Music, Tidal, YouTube Music Amazon Music, TikTok, Tencent & more</h3>

                            
                                <a href="{{ route('distribution') }}" class="btn btn-info btn-lg"><i class="fa fa-search-plus"></i> Get started</a>
