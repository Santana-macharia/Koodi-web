...
Route::get('add-earnings', 'UserController@earnings')->name('add-earnings');
...
Route::get('market', ['as' => 'market', 'uses'=>'AdsController@listing']);
//Route::get('buy', ['as' => 'buy', 'uses'=>'AdsController@buy']);
//Route::get('sell', ['as' => 'sell', 'uses'=>'AdsController@sell']);
...
Route::resource('user', 'UserController');
 ...
 //pending booking payments
    Route::post('payment', 'PaymentController@pendingPayment');
    Route::post('close', 'PaymentController@closeBooking');
    Route::post('book_proceed', 'PaymentController@proceedPayment');
    Route::get('confirm',  'PaymentController@checkoutMpesa')->name('payment');
    Route::post('proceed', 'PaymentController@proceedMpesa');
...
Route::group(['prefix'=>'dashboard', 'middleware' => 'dashboard'], function(){
    ...
    Route::group(['middleware'=>'only_admin_access'], function(){
        Route::group(['prefix'=>'settings'], function(){
            ...
            Route::get('add-earnings', ['as'=>'add-earnings', 'uses' => 'DashboardController@earnings']);
    ...
    Route::get('payments-success', ['as'=>'payments_success', 'uses' => 'PaymentController@coinSuccess']);
    ...
    Route::group(['prefix'=>'u'], function(){
        Route::group(['prefix'=>'posts'], function(){
            ...
            Route::get('checkout/{transaction_id}/paypal-notify', ['as'=>'paypal_notify_url','uses' => 'PaymentController@paypalNotify']);
