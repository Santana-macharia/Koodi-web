...
//exchange coins
    ...
    public function store2(Request $request)
    {
        ...
        if ($created_ad){
            ...
            return redirect(route('pending_ads'))->with('success', trans('app.trade_created_msg'));
    ...
    public function sell(Request $request){
        ...
        return view($this->theme.'selling', compact('ads', 'title', 'countries', 'selected_categories', 'selected_sub_categories', 'selected_countries', 'selected_states', 'premium_ads', 'agents'));
    }
